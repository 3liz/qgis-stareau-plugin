...
-- aep_noeud_doublon()
CREATE FUNCTION stareau.aep_noeud_doublon() RETURNS SETOF stareau_principale.noeud_reseau
    LANGUAGE sql
    AS $$
        SELECT nro.*
...
-- aep_noeud_manquant()
CREATE FUNCTION stareau.aep_noeud_manquant() RETURNS TABLE(fid integer, geom geometry, id_canalisation_upstream text, id_canalisation_downstream text)
    LANGUAGE plpgsql
    AS $$
    BEGIN
        RETURN QUERY
...
-- aep_noeud_orphelin()
CREATE FUNCTION stareau.aep_noeud_orphelin() RETURNS SETOF stareau_principale.noeud_reseau
    LANGUAGE sql
    AS $$
        SELECT nr.*
...
-- aep_pgr_find_captages_from_traitement(integer, text, text)
CREATE FUNCTION stareau.aep_pgr_find_captages_from_traitement(vertex_id integer, target_schema text, target_table text) RETURNS SETOF stareau_aep.aep_canalisation
    LANGUAGE plpgsql
    AS $_$
    BEGIN
...
-- aep_pgr_nearest_closed_vannes(geometry)
CREATE FUNCTION stareau.aep_pgr_nearest_closed_vannes(the_point geometry) RETURNS SETOF stareau_aep.aep_vanne
    LANGUAGE plpgsql
    AS $_$
    BEGIN
        RETURN QUERY EXECUTE
...
-- aep_pgr_nearest_vannes(integer)
CREATE FUNCTION stareau.aep_pgr_nearest_vannes(vertex_id integer) RETURNS SETOF stareau_aep.aep_vanne
    LANGUAGE plpgsql
    AS $_$
    BEGIN
        RETURN QUERY EXECUTE
...
-- aep_pgr_nearest_vannes(geometry)
CREATE FUNCTION stareau.aep_pgr_nearest_vannes(the_point geometry) RETURNS SETOF stareau_aep.aep_vanne
    LANGUAGE plpgsql
    AS $_$
    BEGIN
        RETURN QUERY EXECUTE
...
-- aep_pgr_nearest_vannes_withPoint(geometry)
CREATE FUNCTION stareau."aep_pgr_nearest_vannes_withPoint"(the_point geometry) RETURNS SETOF stareau_aep.aep_vanne
    LANGUAGE plpgsql
    AS $_$
    BEGIN
        RETURN QUERY EXECUTE
...
-- aep_pgr_path_to_nearest_target(integer, text, text)
CREATE FUNCTION stareau.aep_pgr_path_to_nearest_target(vertex_id integer, target_schema text, target_table text) RETURNS SETOF stareau_aep.aep_canalisation
    LANGUAGE plpgsql
    AS $_$
    BEGIN
        RETURN QUERY EXECUTE
...
-- aep_pgr_path_to_nearest_target_avoiding_closed_valves(integer, text, text)
CREATE FUNCTION stareau.aep_pgr_path_to_nearest_target_avoiding_closed_valves(vertex_id integer, target_schema text, target_table text) RETURNS SETOF stareau_aep.aep_canalisation
    LANGUAGE plpgsql
    AS $_$
    BEGIN
        RETURN QUERY EXECUTE
...
-- ass_downstream(text)
CREATE FUNCTION stareau.ass_downstream(id_noeud_reseau text) RETURNS TABLE(idx integer, fid_canalisation integer, fid_noeudinitial integer, id_noeudinitial text, fid_noeudterminal integer, id_noeudterminal text)
    LANGUAGE plpgsql
    AS $_$
    BEGIN
        RETURN QUERY EXECUTE
...
-- ass_noeud_doublon()
CREATE FUNCTION stareau.ass_noeud_doublon() RETURNS SETOF stareau_principale.noeud_reseau
    LANGUAGE sql
    AS $$
        SELECT nro.*
        FROM stareau.ass_noeud_orphelin() nro
...
-- ass_noeud_manquant()
CREATE FUNCTION stareau.ass_noeud_manquant() RETURNS TABLE(fid integer, geom geometry, id_canalisation_upstream text, id_canalisation_downstream text)
    LANGUAGE plpgsql
    AS $$
    BEGIN
        RETURN QUERY
...
-- ass_noeud_orphelin()
CREATE FUNCTION stareau.ass_noeud_orphelin() RETURNS SETOF stareau_principale.noeud_reseau
    LANGUAGE sql
    AS $$
        SELECT nr.*
        FROM stareau_principale.noeud_reseau nr
...
-- ass_upstream(text)
CREATE FUNCTION stareau.ass_upstream(id_noeud_reseau text) RETURNS TABLE(idx integer, fid_canalisation integer, fid_noeudinitial integer, id_noeudinitial text, fid_noeudterminal integer, id_noeudterminal text)
    LANGUAGE plpgsql
    AS $_$
    BEGIN
        RETURN QUERY EXECUTE
...
CREATE FUNCTION stareau.get_current_setting(setting_name text, default_value text, value_type text DEFAULT 'text'::text) RETURNS text
    LANGUAGE plpgsql
    AS $$
DECLARE
    setting_value text;
