...
CREATE INDEX idx_aep_canalisation_noeudterminal ON stareau_aep.aep_canalisation (noeudterminal); --- btree indexation
CREATE INDEX idx_aep_canalisation_noeudinitial ON stareau_aep.aep_canalisation (noeudinitial); --- btree indexation
CREATE INDEX idx_aep_canalisation_id ON stareau_aep.aep_canalisation (id_canalisation); --- btree indexation
